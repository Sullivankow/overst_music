...
function About() {
  return (
    <section
      id="about"
      className="w-full min-h-screen text-white flex items-center justify-center px-4 py-16"
      style={{
        backgroundImage:
          "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/overst_music/assets/bg-vintage7.jpg')",
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="w-full md:w-1/2">
          <img
            src="/overst_music/assets/overst.jpg"
            alt="Øverst portrait"
